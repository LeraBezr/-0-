...
<div class="music-container">     
    ...
    <form action="upload_music.php" method="post" enctype="multipart/formdata">   
        <input type="file" name="music_file" accept=".mp3,.mpeg" required>                 <button type="submit">Загрузить</button>             
</form>         
</div>     
</div> 
</body> 
