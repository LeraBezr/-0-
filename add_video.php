...
<!-- Подключение CSS-файла для стилей меню -->
<link rel="stylesheet" href="../css/loader.css"> <!-- Подключение CSS-файла для стилей загрузчика -->     
<link rel="stylesheet" href="../css/add_video.css"> <!-- Подключение CSS-файла для стилей добавления видео -->     <script src="../js/loader.js"></script> <!-- Подключение скрипта загрузчика --> 
</head> <body>     
    <header> 
    ...
    <?php     
    include("../menu.php"); 
    // Вставка содержимого файла меню 
 include("../application/loader.php"); 
 // Вставка содержимого файла загрузчика     
 ?> 
<div class="container"> 
...
<form action="add_to_base.php" method="post" enctype="multipart/form-data"> 
    ...
    <!-- Поле ввода для названия видео -->            
     ...
     <!-- Метка для выбора источника видео -->             
     ...
     <!-- Первый пункт выпадающего списка -->                 
     <option value="link">Ссылка</option> 
     <!-- Пункт выпадающего списка для ссылки -->                 
     <option value="file">Файл</option> 
     <!-- Пункт выпадающего списка для файла -->             
     ...
     <div id="file_input" class="file-input-container"> 
        ...
        </div> <!-- Закрытие контейнера для ввода ссылки -->             <input type="submit" value="Добавить Видео"> <!-- Кнопка для отправки формы -->         
        </form> <!-- Закрытие формы -->     
 ...
 if (source === "file") { 
    // Если выбран источник файла                 
    fileInput.classList.remove("fade-out"); 
    // Удаляем класс для анимации скрытия загрузки файла                 
    fileInput.classList.add("fade-in"); 
    // Добавляем класс для анимации появления загрузки файла                 
    linkInput.classList.remove("fade-in"); 
    // Удаляем класс для анимации появления ввода ссылки                 
    linkInput.classList.add("fade-out"); 
    // Добавляем класс для анимации скрытия ввода ссылки             
} else { // Если выбран источник ссылки                 
    fileInput.classList.remove("fade-in"); 
    // Удаляем класс для анимации появления загрузки файла                 
    fileInput.classList.add("fade-out"); 
    // Добавляем класс для анимации скрытия загрузки файла                 
    linkInput.classList.remove("fade-out"); 
    // Удаляем класс для анимации скрытия ввода ссылки                 
    linkInput.classList.add("fade-in"); 
    // Добавляем класс для анимации появления ввода ссылки             
}         
} 
</script> <!-- Закрытие скрипта --> </body> <!-- Закрытие тела документа --> </html> <!-- Закрытие HTML-документа --> 
